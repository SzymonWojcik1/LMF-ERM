      ...
      <div className="flex flex-col items-center justify-center py-12 px-4">
        ...
        {isLoading ? (
          ...
          <div className="bg-gray-100 rounded-lg shadow-sm w-full max-w-4xl">
            {/* Table Header */}
            <div className="grid grid-cols-9 bg-gray-200 font-semibold p-4">
            ...
            {clients.length > 0 ? (
              clients.map((client) => (
                <div key={client.cli_id} className="mb-4 border-b border-gray-200">
                  ...
                  <div className="flex justify-center space-x-2 py-2 bg-gray-50">
                    ...
                    <Link
                      href={`/sites/new?clientId=${client.cli_id}`}
