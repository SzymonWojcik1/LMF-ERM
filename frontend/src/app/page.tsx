      ...
      <div className="flex flex-col items-center justify-center min-h-[80vh] px-4">
        ...
        <div className="bg-gray-100 rounded-lg p-8 shadow-sm w-full max-w-md">
          <div className="space-y-4">
            ...
            <a href="/clients" className="flex items-center bg-blue-500 hover:bg-blue-600 text-white py-3 px-4 rounded-md w-full transition-colors duration-200">
              <svg className="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Manage hours button */}
            <a href="/heures" className="flex items-center bg-blue-500 hover:bg-blue-600 text-white py-3 px-4 rounded-md w-full transition-colors duration-200">
              <svg className="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
              </svg>
              <span>Gérer les heures sur les sites</span>
            </a>
